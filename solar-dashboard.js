  ...
  render() {
    ...
    this.shadowRoot.innerHTML = `
      ...
      <section class="card">
        ...
        <section class="content"><article class="panel flow"><div class="panel-header"><div><p class="eyebrow">FLUXO DE ENERGIA</p><h2>Agora</h2></div><span class="updated">Dados do Home Assistant <i></i></span></div><div class="canvas"><svg class="connections" viewBox="0 0 760 460" preserveAspectRatio="none" aria-hidden="true">
          <path class="line orange" d="M70 119 C190 119 330 150 462 191"/>
          <path class="line teal" d="M462 207 C420 250 380 315 337 394"/>
          <path class="line blue-line reverse" d="M500 191 C570 172 625 135 677 118"/>
          <circle class="flow-pulse orange-pulse" cx="245" cy="138" r="5"/>
          <circle class="flow-pulse teal-pulse" cx="396" cy="286" r="5"/>
          <circle class="flow-pulse blue-pulse" cx="589" cy="153" r="4"/>
        </svg>
